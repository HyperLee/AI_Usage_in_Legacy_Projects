...
```plaintext
提示詞範例：
"file:xxx.prompt.md 這是我的大綱，幫我完善規格書內容。
只需要調整內容，先不用實作開發。"
```

**建議模型**:
- 規格書撰寫: Claude Sonnet 4.5 或 Claude Opus 4.5
...
![Copilot SDK 架構圖](https://github.com/user-attachments/assets/6d05a52c-3d74-4eb7-8e29-c2cd86b5ac03)
